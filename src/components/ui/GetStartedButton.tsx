  ...
  return (
    <Button className="group relative overflow-hidden" size="lg" asChild>
      ...
      >
        ...
        <i className="absolute right-1 top-1 bottom-1 rounded-lg z-10 grid w-9 place-items-center transition-all duration-500 bg-bg/15 group-hover:w-[calc(100%-0.5rem)] group-active:scale-95 not-italic">
